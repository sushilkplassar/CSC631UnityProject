...
public class GameDB {
    ...
    public GameDB() {
        ...
        String connectURI = String.format("jdbc:mysql://%s:%s/%s?user=%s&password=%s", configuration.getDBURL(), 3306, configuration.getDBName(), configuration.getDBUsername(), configuration.getDBPassword());
